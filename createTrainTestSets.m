function [trainmat_modes,test_modes,labels_training,labels_test] = createTrainTestSets(range,num_pulse_train,n_pulse,num_noPulse_train,n_pulseless)
...
num_noPulse_test = n_pulse - num_noPulse_train;
