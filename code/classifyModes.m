...
if (strcmp(discriminantType,'Linear' ) && train_testFlag ==1)
...
if (strcmp(discriminantType,'Quadratic' )&& train_testFlag ==1)
...
if (strcmp(discriminantType,'SVM' )&& train_testFlag ==1)
...
if (strcmp(discriminantType,'Linear' )&& train_testFlag ==2)
    [~,~,POSTERIOR] = classify(test_mode, trainmat_mode, labels_training, 'Linear');
    [X,Y,T,AUC,~] = perfcurve(labels_test,POSTERIOR(:,2),1);
end 
